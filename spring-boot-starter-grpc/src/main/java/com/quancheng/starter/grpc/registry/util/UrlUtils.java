...
public class UrlUtils {
    ...
    public static List<URL> parseURLs(String address, Map<String, String> defaults) {
        ...
        String[] addresses = GrpcConstants.REGISTRY_SPLIT_PATTERN.split(address);
    ...
    public static Map<String, String> parseQueryParams(String rawRefer) {
        ...
        String[] kvs = GrpcConstants.QUERY_PARAM_PATTERN.split(refer);
        for (String kv : kvs) {
            if (kv != null && kv.contains(GrpcConstants.EQUAL_SIGN_SEPERATOR)) {
                String[] kvArr = GrpcConstants.EQUAL_SIGN_PATTERN.split(kv);
                if (kvArr.length == 2) {
    ...
    private static URL parseURL(String address, Map<String, String> defaults) {
        ...
        String[] addresses = GrpcConstants.COMMA_SPLIT_PATTERN.split(address);
        ...
        if (port <= 0) {
            if (defaultPort > 0) {
                ...
                changed = true;
                port = GrpcConstants.DEFAULT_INT_VALUE;
            }
        }
