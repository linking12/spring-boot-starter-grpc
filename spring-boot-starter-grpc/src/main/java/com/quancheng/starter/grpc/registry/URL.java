...
public class URL {
    ...
    public String getMethodParameter(String methodName, String paramDesc, String name) {
        String value = getParameter(GrpcConstants.METHOD_CONFIG_PREFIX + methodName + "(" + paramDesc + ")." + name);
    ...
    public String getUri() {
        return protocol + GrpcConstants.PROTOCOL_SEPARATOR + host + ":" + port + GrpcConstants.PATH_SEPARATOR + path;
    }
    ...
    public String getIdentity() {
        return protocol + GrpcConstants.PROTOCOL_SEPARATOR + host + ":" + port + "/"
               + getParameter(URLParamType.group.getName(), URLParamType.group.getValue()) + "/" + getPath() + "/"
    ...
    public boolean canServe(URL refUrl) {
        ...
        if (!StringUtils.equals(this.getParameter(URLParamType.nodeType.getName()), GrpcConstants.NODE_TYPE_SERVICE)) {
            return false;
        }
